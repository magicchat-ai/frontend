...
const PopupModal = (props: PropsType) => {
    ...
    const data = {
        ...
        'special_message': 'What are you waiting for? Make your Christmas more cheerful!',
        'popular': {
            'name': 'Easter Bunny',
            'image': '',
            'price': 19.99
        ...
        'ratings': {
            'score': 4.6,
            'top_review': 'So amazing and lively! Santa got all my wishes tru and it made this day my best christmas ever.',
            'top_score': 5,
            'top_author': 'Nick'
        }
    }
    ...
    return (
        <div className="fixed px-0 inset-0 h-full z-30 bg-[#6E6E6ED9] flex flex-col w-screen overflow-y-scroll">
            <div onClick={()=>props.setModal({})} className="pt-20 w-full flex"></div>
            <div className="px-12 bg-white rounded-t-2xl py-12">
                <div className="flex flex-col flex-wrap w-full gap-y-3 mt-10">
                    ...
                    <span className="flex font-normal text-[#787373] text-xl">{props.tagline}</span>
                </div>
                    ...
                    <div className="flex flex-col w-full max-w-screen-md gap-y-4">
                        ...
                        <div className="flex flex-col px-2">
                            <div className="flex flex-row justify-between">
                                ...
                                <button className="rounded-full bg-[#D60235] text-white text-md py-2 px-6 justify-between flex-wrap hover:bg-[#C2012F]">
                                    Talk to {props.name}
                                </button>
                            </div>
                        ...
                        <div className="flex flex-row py-4 justify-between flex-wrap">
                            ...
                            <button className="flex text-white bg-black py-3 px-8 rounded-md hover:bg-[#1E1E1E] h-min">Start talking</button>
                        </div>
                    </div>
                ...
                <div className="flex flex-row py-8 gap-x-4 gap-y-2 justify-center text-[#5A5A5A]">
                    <span className="flex">
                        &copy; 2023 MagicChat, Inc
                    </span>
                    <span className="flex gap-x-2">
                        <a href="#terms" className="hover:text-black font-bold">Terms of Use</a> 
                        |
                        <a href="#privacy" className="hover:text-black font-bold">Privacy Policy</a>
                    </span>
                </div>
            </div>
        </div>
