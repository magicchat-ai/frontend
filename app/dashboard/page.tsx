	...
	return (
		<main className="max-w-full w-screen overflow-x-clip bg-white">
			...
			<div className="flex w-full justify-center w-screen">
				<div className="flex flex-col max-w-screen-lg my-8 rounded-xl w-full px-8 py-8 justify-center self-center bg-black text-white gap-y-4">
					...
					<button className="flex flex-row bg-white text-black px-6 py-3 my-4 max-w-max">
						Start using now
					</button>
				</div>
			</div>
			...
			<div className="flex w-full w-screen justify-center mb-12">
				<div className="flex flex-col max-w-screen-lg my-8 rounded-xl w-full px-8 py-12 justify-center items-center self-center bg-black gap-y-12">
					...
					<div className="flex flex-col items-center justify-center max-w-screen-sm ">
                        ...
                        <span className="flex flex-row align-center text-white font-semibold text-[#c7c7c7] self-center items-center justify-center">
                            Join over 2,000+ other kids who are chatting with Santa, Easter bunny, Batman, and many more.
						</span>
					</div>
                    <div className="flex flex-row flex-wrap gap-x-4 gap-y-4 font-bold">
                        <button className="flex border-2 px-6 py-2 bg-[#1e1e1e] rounded-lg text-white"> Get started </button>
                        <button className="flex border-2 text-black px-6 py-2 rounded-lg bg-white"> Buy Subscription </button>
                    </div>
				</div>
			</div>
			<Footer />
